      ...
      >
        ...
        {isOpen && (
          <div className="flex flex-col gap-2 mt-2">
            <div className="px-4 py-2 text-[#ebbe7d] hover:bg-[#3a3a3a] cursor-pointer">
              Option 1
            </div>
            <div className="px-4 py-2 text-[#ebbe7d] hover:bg-[#3a3a3a] cursor-pointer">
              Option 2
